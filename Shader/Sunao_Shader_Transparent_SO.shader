...
Shader "Supernatural World In Body/[Stencil Outline]/Transparent" {


	Properties {
		_SIB_transX("SIB_transX", Range(-50.0, 50.0)) = 0
		_SIB_transY("SIB_transY", Range(-50.0, 50.0)) = 0
		_SIB_transZ("SIB_transZ", Range(-50.0, 50.0)) = 0
		_SIB_rotateX("SIB_rotateX", Range(-360.0, 360.0)) = 0
		_SIB_rotateY("SIB_rotateY", Range(-360.0, 360.0)) = 0
		_SIB_rotateZ("SIB_rotateZ", Range(-360.0, 360.0)) = 0
		_SIB_SplitLevelA("SIB_SplitLevelA", Range(0.0, 10.0)) = 1.49
		_SIB_SplitLevelB("SIB_SplitLevelB", Range(0.0, 10.0)) = 4.15
		_SIB_EnvironmentLightColor("SIB_EnvironmentLightColor", Color) = (0,0,0,1)
		[IntRange] _SIB_RenderingAccuracyA("SIB_RenderingAccuracyA", Range(0, 10)) = 5
		[IntRange] _SIB_RenderingAccuracyB("SIB_RenderingAccuracyB", Range(0, 100)) = 50
		// [IntRange] _SIB_RenderingAccuracyC("SIB_RenderingAccuracyC", Range(5, 120)) = 20
		_SIB_RenderingDistance("SIB_RenderDistance", Range(0.0, 10.0)) = 0.3
	...
	SubShader {
		...
		Pass{
			...
			#pragma vertex vert
			#pragma fragment frag
			#include "./cginc/SunaoShader_SIB.cginc"
			ENDCG
		}
	}
