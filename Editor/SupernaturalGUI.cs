...
//                              VRChat  : てみず（てずみ）
//
// Original: https://booth.pm/ja/items/1723985
...
namespace Supernatural {
	...
	public class GUI : ShaderGUI {
		...
		MaterialProperty SIB_transX;
		MaterialProperty SIB_transY;
		MaterialProperty SIB_transZ;
		MaterialProperty SIB_rotateX;
		MaterialProperty SIB_rotateY;
		MaterialProperty SIB_rotateZ;
		MaterialProperty SIB_SplitLevelA;
		MaterialProperty SIB_SplitLevelB;
		MaterialProperty SIB_EnvironmentLightColor;
		MaterialProperty SIB_RenderingAccuracyA;
		MaterialProperty SIB_RenderingAccuracyB;
		//MaterialProperty SIB_RenderingAccuracyC;
		MaterialProperty SIB_RenderingDistance;
		...
		public override void OnGUI(MaterialEditor ME , MaterialProperty[] Prop) {
			...
			SIB_transX		  = FindProperty("_SIB_transX"		  , Prop , false);
			SIB_transY		  = FindProperty("_SIB_transY"		  , Prop , false);
			SIB_transZ		  = FindProperty("_SIB_transZ"		  , Prop , false);
			SIB_rotateX		  = FindProperty("_SIB_rotateX"	  , Prop , false);
			SIB_rotateY		  = FindProperty("_SIB_rotateY"		  , Prop , false);
			SIB_rotateZ		  = FindProperty("_SIB_rotateZ"		  , Prop , false);
			SIB_SplitLevelA		  = FindProperty("_SIB_SplitLevelA"		  , Prop , false);
			SIB_SplitLevelB		  = FindProperty("_SIB_SplitLevelB"		  , Prop , false);
			SIB_EnvironmentLightColor = FindProperty("_SIB_EnvironmentLightColor", Prop, false);
			SIB_RenderingAccuracyA = FindProperty("_SIB_RenderingAccuracyA", Prop, false);
			SIB_RenderingAccuracyB = FindProperty("_SIB_RenderingAccuracyB", Prop, false);
			//SIB_RenderingAccuracyC = FindProperty("_SIB_RenderingAccuracyC", Prop, false);
			SIB_RenderingDistance = FindProperty("_SIB_RenderingDistance", Prop, false);
			...
			GUILayout.Label("SpaceInBody", EditorStyles.boldLabel);
			using (new EditorGUILayout.VerticalScope("box")) {

				using (new EditorGUILayout.VerticalScope("box")) {

					GUILayout.Label("position", EditorStyles.boldLabel);
					ME.ShaderProperty(SIB_transX , new GUIContent("X-axis"));
					ME.ShaderProperty(SIB_transY , new GUIContent("Y-axis"));
					ME.ShaderProperty(SIB_transZ , new GUIContent("Z-axis"));
					GUILayout.Label("rotation", EditorStyles.boldLabel);
					ME.ShaderProperty(SIB_rotateX , new GUIContent("Xrotate"));
					ME.ShaderProperty(SIB_rotateY , new GUIContent("Yrotate"));
					ME.ShaderProperty(SIB_rotateZ , new GUIContent("Zrotate"));
					GUILayout.Label("Others", EditorStyles.boldLabel);
					ME.ShaderProperty(SIB_SplitLevelA , new GUIContent("SplitLevelA"));
					ME.ShaderProperty(SIB_SplitLevelB , new GUIContent("SplitLevelB"));
					ME.ShaderProperty(SIB_EnvironmentLightColor , new GUIContent("Color"));
					ME.ShaderProperty(SIB_RenderingAccuracyA, new GUIContent("RenderingAccuracyA"));
					ME.ShaderProperty(SIB_RenderingAccuracyB, new GUIContent("RenderingAccuracyB"));
					//ME.ShaderProperty(SIB_RenderingAccuracyC, new GUIContent("RenderingAccuracyC"));
					ME.ShaderProperty(SIB_RenderingDistance, new GUIContent("RenderingDistance"));
